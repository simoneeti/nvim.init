...
if is_available "toggleterm.nvim" then
  ...
  maps.t["<Esc>"] = { [[<C-\><C-n>]], desc = "Cerrar terminal" }
  maps.t["<C-w>"] = { [[<C-\><C-n><C-w>]], desc = "Cerrar terminal" }
end
...
maps.v["F"] = { "<cmd>HopWord<cr>", desc = "salten putoos" }
maps.n["F"] = { "<cmd>HopWord<cr>", desc = "salten putoos" }

maps.n["<C-Down>"] = { "5<Down>", desc = "abajo abajo" }
maps.n["<C-Up>"] = { "5<Up>", desc = "arriba arriba" }
